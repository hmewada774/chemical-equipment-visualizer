...
## 📝 Usage
1. **Register/Login** using the application (Default admin: `admin` / `password123`).
2. **Upload** a CSV file containing columns: `Equipment Name`, `Type`, `Flowrate`, `Pressure`, `Temperature`.
3. View **Analytics** on the dashboard.
4. **Download** a PDF summary report.
